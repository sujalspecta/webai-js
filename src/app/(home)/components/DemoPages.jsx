...
const DemoPages = () => {
  return <section className="py-20" id="demo">
      <div className="container">
        ...
        <div className="aos-init aos-animate flex flex-wrap justify-center" data-aos="fade-up" data-aos-duration={1000}>
          {demosPages.map((page, idx) => <Link to={page.url} target="_blank" className="w-full p-3 lg:w-1/2" key={idx}>
